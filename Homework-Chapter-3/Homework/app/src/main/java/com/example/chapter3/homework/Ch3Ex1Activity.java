...
public class Ch3Ex1Activity extends AppCompatActivity {
    ...
    private static final String TAG = "Ch3Ex1Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                // 提示1：可以参考 https://airbnb.io/lotti/#/android?id=custom-animators
                ...
                float animateProgress = progress / 100f;
                Log.d(TAG, "onProgressChanged: "+progress);
                animationView.setProgress(animateProgress);
            }
